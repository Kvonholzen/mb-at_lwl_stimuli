...
measures$language <- wordbank_lang
...
if(class(admin_info) == "try-error"){
  
  measures$Wordbank_AoA_understands <- NA
  measures$Wordbank_AoA_produces <- NA
...
word_list <- pull(aoa.m, definition)  
